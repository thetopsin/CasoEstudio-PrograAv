...
El problema se resolvió utilizando el paradigma de programación funcional en Kotlin. Nos apoyamos en funciones de orden superior, clausuras y recursividad, asegurando la inmutabilidad de los datos y evitando el uso de estados nombrados o ciclos imperativos tradicionales[cite: 1, 3].
...
Para probar el código, abre tu terminal en la carpeta donde guardaste los archivos `Main.kt` y `Functions.kt`, y ejecuta estos comandos uno tras otro[cite: 1]:
